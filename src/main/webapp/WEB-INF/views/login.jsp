                    ...
                    <form action='<spring:url value="/customer/account/login"></spring:url>' method="post" id="login-form">
                      <div class="col2-set row">
                        ...
                        <div class="col-md-6 registered-users" >
                          <div class="cus-wrapper-login"  ng-app="Customer" ng-controller="loginCtrl">
                            <div class="content">
                              ...
                              <ul class="form-list">
                                <li><label for="email" class="required"><em>*</em>Email Address</label>
                                  <div class="input-box">
                                    <input  type="text" ng-model="email" name="login[username]" id="email" class="input-text required-entry validate-email" title="Email Address">
                                ...
                                <li><label for="pass" class="required"><em>*</em>Password</label>
                                  <div class="input-box">
                                    <input type="password" ng-model="password" name="login[password]" class="input-text required-entry validate-password" id="pass" title="Password">
                            ...
                            <div class="buttons-set">
                              <button type="button" ng-click="login()" class="button" title="Login" name="send" id="send2">
